...
var Appwrite = class {
  constructor() {
    ...
    this.database = {
      ...
      createDocument: (collectionId, data, read2 = [], write = [], parentDocument = "", parentProperty = "", parentPropertyType = "assign") => __awaiter(this, void 0, void 0, function* () {
        if (collectionId === void 0) {
          throw new AppwriteException('Missing required parameter: "collectionId"');
        }
        if (data === void 0) {
      ...
      updateDocument: (collectionId, documentId, data, read2 = [], write = []) => __awaiter(this, void 0, void 0, function* () {
        if (collectionId === void 0) {
          throw new AppwriteException('Missing required parameter: "collectionId"');
        }
        if (documentId === void 0) {
    ...
    this.storage = {
      ...
      createFile: (file, read2 = [], write = []) => __awaiter(this, void 0, void 0, function* () {
        if (file === void 0) {
      ...
      updateFile: (fileId, read2, write) => __awaiter(this, void 0, void 0, function* () {
        if (fileId === void 0) {
          throw new AppwriteException('Missing required parameter: "fileId"');
        }
        if (read2 === void 0) {
...
var template = ({ head, body }) => '<!DOCTYPE html>\r\n<html lang="en">\r\n	<head>\r\n		<meta charset="utf-8" />\r\n		<link rel="icon" href="/favicon.ico" />\r\n		<meta name="viewport" content="width=device-width, initial-scale=1" />\r\n\r\n		' + head + '\r\n	</head>\r\n	<body data-theme="dracula" class="bg-base-100 m-5">\r\n		<div id="svelte">' + body + "</div>\r\n	</body>\r\n</html>\r\n";
var options = null;
...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-45f0ed09.js",
      css: ["/./_app/assets/start-0826e215.css"],
      js: ["/./_app/start-45f0ed09.js", "/./_app/chunks/vendor-9162b4a9.js"]
    },
    fetched: void 0,
    floc: false,
...
var manifest = {
  ...
  routes: [
    ...
    },
    {
      ...
      pattern: /^\/poll\/([^/]+?)\/?$/,
      params: (m) => ({ id: d(m[1]) }),
      a: ["src/routes/__layout.svelte", "src/routes/poll/[id].svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    }
  ]
};
...
var module_lookup = {
  ...
  "src/routes/poll/[id].svelte": () => Promise.resolve().then(function() {
    return _id_;
  })
};
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "/./_app/pages/__layout.svelte-adf147e9.js", "css": ["/./_app/assets/pages/__layout.svelte-9d6b11af.css"], "js": ["/./_app/pages/__layout.svelte-adf147e9.js", "/./_app/chunks/vendor-9162b4a9.js"], "styles": null }, ".svelte-kit/build/components/error.svelte": { "entry": "/./_app/error.svelte-19685e46.js", "css": [], "js": ["/./_app/error.svelte-19685e46.js", "/./_app/chunks/vendor-9162b4a9.js"], "styles": null }, "src/routes/index.svelte": { "entry": "/./_app/pages/index.svelte-741cf018.js", "css": ["/./_app/assets/pages/index.svelte-5d331a2d.css"], "js": ["/./_app/pages/index.svelte-741cf018.js", "/./_app/chunks/vendor-9162b4a9.js", "/./_app/pages/panel/index.svelte-c9123509.js", "/./_app/chunks/appwrite-2957431f.js", "/./_app/pages/panel/Card.svelte-5ce7906b.js", "/./_app/pages/panel/Create.svelte-84a9f926.js"], "styles": null }, "src/routes/panel/index.svelte": { "entry": "/./_app/pages/panel/index.svelte-c9123509.js", "css": [], "js": ["/./_app/pages/panel/index.svelte-c9123509.js", "/./_app/chunks/vendor-9162b4a9.js", "/./_app/chunks/appwrite-2957431f.js", "/./_app/pages/panel/Card.svelte-5ce7906b.js", "/./_app/pages/panel/Create.svelte-84a9f926.js"], "styles": null }, "src/routes/panel/Create.svelte": { "entry": "/./_app/pages/panel/Create.svelte-84a9f926.js", "css": [], "js": ["/./_app/pages/panel/Create.svelte-84a9f926.js", "/./_app/chunks/vendor-9162b4a9.js", "/./_app/chunks/appwrite-2957431f.js"], "styles": null }, "src/routes/panel/Card.svelte": { "entry": "/./_app/pages/panel/Card.svelte-5ce7906b.js", "css": [], "js": ["/./_app/pages/panel/Card.svelte-5ce7906b.js", "/./_app/chunks/vendor-9162b4a9.js", "/./_app/chunks/appwrite-2957431f.js"], "styles": null }, "src/routes/poll/index.svelte": { "entry": "/./_app/pages/poll/index.svelte-5db9c749.js", "css": [], "js": ["/./_app/pages/poll/index.svelte-5db9c749.js", "/./_app/chunks/vendor-9162b4a9.js", "/./_app/chunks/appwrite-2957431f.js"], "styles": null }, "src/routes/poll/[id].svelte": { "entry": "/./_app/pages/poll/[id].svelte-8db12911.js", "css": [], "js": ["/./_app/pages/poll/[id].svelte-8db12911.js", "/./_app/chunks/vendor-9162b4a9.js", "/./_app/chunks/appwrite-2957431f.js"], "styles": null } };
...
var server = {
  endpoint: "https://api.fa97.de/v1".toString(),
  project: "60a2e6bf46842".toString()
};
...
var Card = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let { id } = $$props;
  let { answers = "No answer provided" } = $$props;
  let { result = "No result provided" } = $$props;
  let css2 = "";
  ...
  return `<div class="${"card flex-grow m-5 lg:w-1/3 md:w-1/3 w-full shadow-lg bg-base-200 " + escape2(css2)}"><div class="${"card-body"}"><h2 class="${"card-title"}">${escape2(question)}</h2>
    <p>Answers: ${escape2(answers)}</p>
    <p>Result: ${escape2(result)}</p>
    <div class="${"card-actions"}"><button class="${"btn btn-primary"}">Delete</button></div></div></div>`;
});
...
var Create = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let options2;
  let answer;
  return `<div class="${"card lg:card-side bordered text-base-content mt-5"}"><div class="${"card-body"}"><div class="${"flex flex-col text-center w-full"}"><h2 class="${"card-title text-center text-5xl font-bold mb-8"}">Create Poll
            </h2></div>
        <div class="${"flex flex-wrap"}"><div class="${"p-10 card bg-base-200 w-full"}"><div class="${"form-control"}"><label class="${"label"}"><span class="${"label-text"}">Question</span></label>
                    <input type="${"text"}" class="${"input"}"${add_attribute("value", question, 1)}>
                    <label class="${"label mt-5"}"><span class="${"label-text"}">Options</span></label>
                    <input type="${"text"}" class="${"input"}"${add_attribute("value", options2, 1)}>
                    <label class="${"label mt-5"}"><span class="${"label-text"}">Answer</span></label>
                    <input type="${"text"}" class="${"input"}"${add_attribute("value", answer, 1)}>
                    <button class="${"btn btn-primary mt-10"}">Create</button></div></div></div></div></div>`;
});
...
var Panel = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${status == 1 ? `<div class="${"card lg:card-side bordered text-base-content"}"><div class="${"card-body"}"><div class="${"flex flex-col text-center w-full"}"><h2 class="${"card-title text-center text-5xl font-bold"}">Edit documents </h2></div>
    <div class="${"flex flex-wrap"}">${each(data.documents, (data2, i) => `${validate_component(Card, "Card").$$render($$result, {
    question: data2.question,
    id: data2.$id,
    answers: data2.answers,
    result: data2.result
  }, {}, {})}`)}</div></div></div>
  ${validate_component(Create, "Create").$$render($$result, {}, {}, {})}` : ``}
${status == 2 ? `<div class="${"alert"}"><div class="${"flex-1 text-base-content"}"><svg xmlns="${"http://www.w3.org/2000/svg"}" fill="${"none"}" viewBox="${"0 0 24 24"}" stroke="${"#ff5722"}" class="${"w-6 h-6 mx-2"}"><path stroke-linecap="${"round"}" stroke-linejoin="${"round"}" stroke-width="${"2"}" d="${"M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636"}"></path></svg> 
    <label for="${"noaccess"}">You don&#39;t have access to the panel!</label></div> 
  <div class="${"flex-none"}"></div></div>` : ``}`;
});
...
var css = {
  code: "ul.svelte-neo22{overflow-x:hidden;overflow-y:scroll}ul.svelte-neo22::-webkit-scrollbar{display:none}",
  map: `{"version":3,"file":"index.svelte","sources":["index.svelte"],"sourcesContent":["<script>\\r\\n    import { onMount } from \\"svelte\\";\\r\\n\\r\\n    let themes = [\\r\\n        {\\"name\\": \\"\u{1F4A1} light\\", \\"value\\": \\"light\\"},\\r\\n        {\\"name\\": \\"\u{1F311} dark\\", \\"value\\": \\"dark\\"},\\r\\n        {\\"name\\": \\"\u{1F9C1} cupcake\\", \\"value\\": \\"cupcake\\"},\\r\\n        {\\"name\\": \\"\u{1F41D} bumblebee\\", \\"value\\": \\"bumblebee\\"},\\r\\n        {\\"name\\": \\"\u{1F48E} emerald\\", \\"value\\": \\"emerald\\"},\\r\\n        {\\"name\\": \\"\u{1F3DA} corporate\\", \\"value\\": \\"corporate\\"},\\r\\n        {\\"name\\": \\"\u{1F30A} synthwave\\", \\"value\\": \\"synthwave\\"},\\r\\n        {\\"name\\": \\"\u{1F4FA} retro\\", \\"value\\": \\"retro\\"},\\r\\n        {\\"name\\": \\"\u{1F9EC} cyberpunk\\", \\"value\\": \\"cyberpunk\\"},\\r\\n        {\\"name\\": \\"\u2764 valentine\\", \\"value\\": \\"valentine\\"},\\r\\n        {\\"name\\": \\"\u{1F383} halloween\\", \\"value\\": \\"halloween\\"},\\r\\n        {\\"name\\": \\"\u{1F337} garden\\", \\"value\\": \\"garden\\"},\\r\\n        {\\"name\\": \\"\u{1F332} forest\\", \\"value\\": \\"forest\\"},\\r\\n        {\\"name\\": \\"\u{1F4A7} aqua\\", \\"value\\": \\"aqua\\"},\\r\\n        {\\"name\\": \\"\u{1F3A7} lofi\\", \\"value\\": \\"lofi\\"},\\r\\n        {\\"name\\": \\"\u{1F3A8} pastel\\", \\"value\\": \\"pastel\\"},\\r\\n        {\\"name\\": \\"\u{1F308} fantasy\\", \\"value\\": \\"fantasy\\"},\\r\\n        {\\"name\\": \\"\u{1F533} wireframe\\", \\"value\\": \\"wireframe\\"},\\r\\n        {\\"name\\": \\"\u26AB black\\", \\"value\\": \\"black\\"},\\r\\n        {\\"name\\": \\"\u{1F48D} luxury\\", \\"value\\": \\"luxury\\"},\\r\\n        {\\"name\\": \\"\u{1F9DB}\u200D\u2642\uFE0F dracula\\", \\"value\\": \\"dracula\\"},\\r\\n    ];\\r\\n\\r\\n    onMount(() => {\\r\\n        const theme = localStorage.getItem('theme');\\r\\n        document.body.setAttribute(\\"data-theme\\", theme);\\r\\n    });\\r\\n    function changeTheme(name) {\\r\\n        document.body.setAttribute(\\"data-theme\\", name);\\r\\n        localStorage.setItem('theme', name);\\r\\n    }\\r\\n<\/script>\\r\\n\\r\\n<div class=\\"dropdown dropdown-end dropdown-hover\\">\\r\\n    <div tabindex=\\"0\\" class=\\"m-1 btn\\">Theme</div>\\r\\n    <ul class=\\"shadow menu dropdown-content bg-gray-800 text-white rounded-box w-52 h-96\\">\\r\\n        <li class=\\"bg-gray-900\\">\\r\\n            <a>\u2193 Scroll \u2193</a>\\r\\n        </li>\\r\\n        {#each themes as {name,value}}\\r\\n        <li on:click={() => changeTheme(value)}>\\r\\n            <a>{name}</a>\\r\\n        </li>\\r\\n       {/each}\\r\\n    </ul>\\r\\n</div>\\r\\n\\r\\n<style>ul{overflow-x:hidden;overflow-y:scroll}ul::-webkit-scrollbar{display:none}</style>\\r\\n"],"names":[],"mappings":"AAmDO,eAAE,CAAC,WAAW,MAAM,CAAC,WAAW,MAAM,CAAC,eAAE,mBAAmB,CAAC,QAAQ,IAAI,CAAC"}`
};
var ThemeSwitcher = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let themes = [
    ...
    { "name": "\u{1F48E} emerald", "value": "emerald" },
    {
      "name": "\u{1F3DA} corporate",
      "value": "corporate"
    },
    {
      "name": "\u{1F30A} synthwave",
      "value": "synthwave"
    },
    { "name": "\u{1F4FA} retro", "value": "retro" },
    {
      "name": "\u{1F9EC} cyberpunk",
      "value": "cyberpunk"
    },
    {
      "name": "\u2764 valentine",
  ...
  $$result.css.add(css);
  return `<div class="${"dropdown dropdown-end dropdown-hover"}"><div tabindex="${"0"}" class="${"m-1 btn"}">Theme</div>
    <ul class="${"shadow menu dropdown-content bg-gray-800 text-white rounded-box w-52 h-96 svelte-neo22"}"><li class="${"bg-gray-900"}"><a>\u2193 Scroll \u2193</a></li>
        ${each(themes, ({ name, value }) => `<li><a>${escape2(name)}</a>
        </li>`)}</ul>
</div>`;
});
var Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let user;
  let name = "";
  let image = "https://discord.com/assets/6debd47ed13483642cf09e832ed0bc1b.png";
  onMount(() => {
    let promise = sdk.account.get();
    promise.then(function(response) {
      user = response;
      name = user.name;
      let promise2 = sdk.account.getSessions();
      promise2.then(function(response2) {
        fetch("https://discord.com/api/users/@me", {
          headers: {
            authorization: `Bearer ${response2.sessions[0].providerToken}`
          }
        }).then((result) => result.json()).then((response3) => {
          image = `https://cdn.discordapp.com/avatars/${response3.id}/${response3.avatar}.webp?size=128`;
        }).catch(console.error);
      }, function(error22) {
        console.log(error22);
      });
...
<div class="${"navbar mb-2 shadow-lg bg-neutral text-neutral-content rounded-box"}"><div class="${"flex-none px-2 mx-2"}"><span class="${"text-lg font-bold"}">Testing </span></div>
	<div class="${"flex-1 px-2 mx-2"}">${user ? `<div class="${"items-stretch lg:flex"}"><a class="${"btn btn-ghost btn-sm rounded-btn"}">Logout
				</a></div>` : `<div class="${"items-stretch hidden lg:flex"}"><a class="${"btn btn-ghost btn-sm rounded-btn"}">Login
				</a></div>`}</div>
	<div class="${"flex-none hidden px-2 mx-2 lg:flex"}"><div class="${"flex items-stretch"}">${validate_component(ThemeSwitcher, "ThemeSwitcher").$$render($$result, {}, {}, {})}</div></div>
	<div class="${"flex-none"}"><div class="${"flex items-stretch"}">${user ? `<button class="${"btn no-animation"}">${escape2(name)}</button>` : ``}</div>
		<div class="${"flex-none"}"><div class="${"avatar"}"><div class="${"rounded-full w-10 h-10 m-1"}"><img${add_attribute("src", image, 0)}></div></div></div></div></div>`;
});
var prerender = true;
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `${$$result.title = `<title>Discord login</title>`, ""}`, ""}
${validate_component(Navbar, "Navigation").$$render($$result, {}, {}, {})}
<div class="${"mt-6"}">${validate_component(Panel, "Panel").$$render($$result, {}, {}, {})}</div>`;
});
...
var Poll = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"hero bg-base-200 text-white rounded-lg"}"><div class="${"text-center hero-content mb-5"}"><div class="${"max-w-md"}"><h1 class="${"mb-5 text-5xl font-bold"}">Polls</h1>
            <p class="${"mb-5"}"></p>
            ${data ? `${each(data, (item) => `<a href="${"/poll/" + escape2(item.$id)}" class="${"no-underline"}"><div class="${"btn btn-primary w-80 mt-5"}">${escape2(item.question)}</div>
                    </a>`)}` : ``}
            ${!data ? `<div class="${"btn btn-primary w-80 mt-5"}">Loading...
        </div>` : ``}</div></div></div>`;
});
...
var U5Bidu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `${$$result.head += `${$$result.title = `<title>${escape2(question)}</title>`, ""}`, ""}

<div class="${"hero bg-base-200 text-white rounded-lg"}">${status == 1 ? `<div class="${"text-center hero-content mb-5 mt-5"}"><div class="${"max-w-md"}"><h1 class="${"mb-5 text-5xl font-bold"}">${escape2(question)}</h1>
				${each(data.answers, (item) => `<div class="${"btn btn-primary w-80 mt-5"}">${escape2(item)}
					</div>`)}
				<div class="${"btn btn-secondary w-80 mt-5"}">Answer: ${escape2(data.result)}</div>
				${!data ? `<div class="${"btn btn-primary w-80 mt-5"}">Loading...</div>` : ``}</div></div>` : ``}
	${status == 2 ? `<div class="${"text-center hero-content mb-5 mt-5"}"><div class="${"max-w-md"}"><h1 class="${"mb-5 text-5xl font-bold"}">Unknown Poll</h1></div></div>` : ``}</div>`;
});
