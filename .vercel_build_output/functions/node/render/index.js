          ...
          if (fetch4.isRedirect(res.statusCode)) {
            ...
            switch (request.redirect) {
              ...
              case "follow":
                ...
                resolve2(fetch4(new Request2(locationURL, requestOpts)));
                finalize();
                return;
            }
          }
...
var Poll = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<section class="${"bg-white"}"><div class="${"flex flex-wrap overflow-hidden"}"><div class="${"w-full overflow-hidden md:w-1/3 lg:w-1/3 xl:w-1/3"}"></div>

        <div class="${"shadow-2xl w-full overflow-hidden md:w-1/3 lg:w-1/3 xl:w-1/3 m-20 bg-gradient-to-r from-blue-500 to-blue-700 rounded-md"}"><div class="${"shadow-md rounded-md overflow-hidden text-center"}"><div class="${"text-white m-5 text-5xl font-semibold"}">Questions
                </div>

                ${data ? `${each(data, (item) => `<a href="${"/poll/" + escape2(item.$id)}" class="${"no-underline"}"><div class="${"shadow-2xl m-5 bg-white text-blue-500 px-6 py-3 mt-4 rounded-md shadow-md text-xl font-semibold uppercase transform duration-200 ease-in-out focus:outline-none hover:-translate-y-1"}">${escape2(item.question)}</div>
                        </a>`)}` : ``}
                ${!data ? `<div class="${"m-5 bg-white text-blue-500 px-6 py-3 mt-4 rounded-md shadow-md text-xl font-semibold uppercase transform duration-200 ease-in-out focus:outline-none hover:-translate-y-1"}">Loading
                    </div>` : ``}</div></div>

        <div class="${"w-full overflow-hidden md:w-1/3 lg:w-1/3 xl:w-1/3"}"></div></div></section>`;
});
...
<section class="${"bg-white"}">${status == 1 ? `<div class="${"flex flex-wrap overflow-hidden"}"><div class="${"w-full overflow-hidden md:w-1/3 lg:w-1/3 xl:w-1/3"}"></div>

			<div class="${"w-full overflow-hidden md:w-1/3 lg:w-1/3 xl:w-1/3 m-20 bg-gradient-to-r from-blue-500 to-blue-700 shadow-2xl rounded-md"}"><div class="${"shadow-md rounded-md overflow-hidden text-center"}"><div class="${"text-white m-5 text-5xl font-semibold"}">${escape2(data.question)}</div>
					${each(data.answers, (item) => `<div class="${"p-5"}"><p class="${"text-white text-xl font-semibold uppercase"}">${escape2(item)}</p>
						</div>`)}

					<button class="${"shadow-2xl cursor-default m-5 bg-white text-blue-500 px-6 py-3 mt-4 rounded-md shadow-md text-xl font-semibold uppercase focus:outline-none"}">Answer: ${escape2(data.result)}</button></div></div>

			<div class="${"w-full overflow-hidden md:w-1/3 lg:w-1/3 xl:w-1/3"}"></div></div>` : ``}
	${status == 2 ? `<div class="${"flex flex-wrap overflow-hidden"}"><div class="${"w-1/3 overflow-hidden"}"></div>

			<div class="${"w-1/3 overflow-hidden m-20 bg-gradient-to-r from-red-500 to-red-700 shadow-2xl rounded-md"}"><div class="${"shadow-md rounded-md overflow-hidden text-center"}"><div class="${"text-white m-5 text-6xl font-semibold"}">Unknown Poll
					</div></div></div>

			<div class="${"w-1/3 overflow-hidden"}"></div></div>` : ``}</section>`;
});
