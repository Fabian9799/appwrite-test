...
<section class="bg-white">
	{#if status == 1}
		<div class="flex flex-wrap overflow-hidden">
			...
			<div
				class="w-full overflow-hidden md:w-1/3 lg:w-1/3 xl:w-1/3 m-20 bg-gradient-to-r from-blue-500 to-blue-700 shadow-2xl rounded-md"
			>
	...
	{#if status == 2}
		<div class="flex flex-wrap overflow-hidden">
			...
			<div
				class="w-1/3 overflow-hidden m-20 bg-gradient-to-r from-red-500 to-red-700 shadow-2xl rounded-md"
			>
				<div class="shadow-md rounded-md overflow-hidden text-center">
